  ...
  plugins = [
    ...
    pkgs.tmuxPlugins.tilish
    {
      ...
      extraConfig = ''
        ...
        set -g status-left "#[fg=black,bg=yellow]%F#[fg=yellow,bg=green]\u258C#[default]%T#[fg=green,bg=colour13]\u258C#[fg=black,bg=colour13] #(cat /proc/uptime | cut -d ' ' -f 1 | xargs -I int date -u -s @int +%T) #[default] [#S] "
      '';
    }
